...
/**
  ...
  * 增量机器学习算法的框架，由一个预先计算的模型组成，该模型根据新的输入和新的输入数据进行更新，作业为其提供预测。
  *
  * This may serve as a base of a number of algorithms, e.g. updating an
  * incremental Alternating Least Squares model while also providing the
  * predictions.
  * 这可以作为许多算法的基础，例如更新增量交替最小二乘模型，同时提供预测。
  *
  ...
  */
@Test
class IncrementalLearningSkeleton {
...
//    }
  ...
  /**
    ...
    */
  private class FiniteNewDataSource extends SourceFunction[Int] with Serializable {
  ...
  /**
    ...
    */
  private class FiniteTrainingDataSource extends SourceFunction[Int] with Serializable{
